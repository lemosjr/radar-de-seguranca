...
const DADOS_MOCKADOS_OFFLINE = [
    ...
    { nome: '1ª Cia / 1º BBM (Jacarecan)',corporacao: 'CBM', regional: 'SER I',   latitude: -3.725000, longitude: -38.541000, efetivo: 40  },
...
// Estrutura pronta para ser substituída por chamada à API real
// ==========================================
...
// ==========================================
// GRÁFICOS — UNIDADES E EFETIVO (centro)
// ==========================================
...
// ==========================================
// GRÁFICOS — OCORRÊNCIAS (sidebar esquerda)
// Substitua OCORRENCIAS_MOCKADAS por fetch à API quando disponível
// ==========================================
function renderizarGraficosOcorrencias() {
    ...
    // — Gráfico 1: Ocorrências por Região (barras horizontais) —
    ...
    // — Gráfico 2: Ocorrências por Período do Dia (barras verticais com cor por turno) —
        ...
        graficoOcorrPeriodo = new Chart(ctxPeriodo, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    borderColor: AMBER_BG.map(c => c.replace('0.85', '1')),
                    borderWidth: 0,
                    borderRadius: 5
                }]
            },
